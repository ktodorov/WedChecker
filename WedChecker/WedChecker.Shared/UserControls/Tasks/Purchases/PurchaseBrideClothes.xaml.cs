    ...
    public sealed partial class PurchaseBrideClothes : BaseTaskControl
    {
        ...
        public List<string> StoredClothes
        {
            get
            {
                ...
                {
                    _storedClothes = AppData.GetGlobalValues(TaskData.Tasks.BrideClothes.ToString());
                }
        ...
        {
            writer.Write(TaskData.Tasks.PurchaseBrideClothes.ToString());
        ...
        {
            await AppData.InsertGlobalValue(TaskData.Tasks.PurchaseBrideClothes.ToString());
        }
