...
{
    public sealed partial class PurchaseBrideAccessories : PurchaseTaskBaseControl
    {
        protected override List<string> ItemsAppDataName
        {
            get
            {
                var result = new List<string> { "BrideAccessories" };
                return result;
            }
        }
        ...
        protected override string ItemsMissingExceptionText
        {
            get
            {
                return "You must first add bride accessories in order to mark them purchased after that!";
            }
        }
        ...
        public override string TaskCode
        {
            get
            {
                return Business.Models.Enums.Tasks.PurchaseBrideAccessories.ToString();
            }
        }
    }
}
